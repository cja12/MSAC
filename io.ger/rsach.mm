   ...
   % Strings
   %
   sh.kstnm = fscanf(fid,'%8s',1);
   sh.kevnm = fscanf(fid,'%16s',1);           
   sh.khole = fscanf(fid,'%8s',1);
   sh.ko = fscanf(fid,'%8s',1);
   sh.ka = fscanf(fid,'%8s',1);               
   sh.kt0 = fscanf(fid,'%8s',1);
   sh.kt1 = fscanf(fid,'%8s',1);
   sh.kt2 = fscanf(fid,'%8s',1);              
   sh.kt3 = fscanf(fid,'%8s',1);
   sh.kt4 = fscanf(fid,'%8s',1);
   sh.kt5 = fscanf(fid,'%8s',1);              
   sh.kt6 = fscanf(fid,'%8s',1);
   sh.kt7 = fscanf(fid,'%8s',1);
   sh.kt8 = fscanf(fid,'%8s',1);              
   sh.kt9 = fscanf(fid,'%8s',1);
   sh.kf = fscanf(fid,'%8s',1);
   sh.kuser0 = fscanf(fid,'%8s',1);           
   sh.kuser1 = fscanf(fid,'%8s',1);
   sh.kuser2 = fscanf(fid,'%8s',1);
   sh.kcmpnm = fscanf(fid,'%8s',1);           
   sh.knetwk = fscanf(fid,'%8s',1);
   sh.kdatrd = fscanf(fid,'%8s',1);
   sh.kinst = fscanf(fid,'%8s',1);            
   %
