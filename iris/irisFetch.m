classdef irisFetch
   ...
   methods(Static)
      ...
      function success = connectTo_IRIS_WS_jar(isSilent)
         ...
         RequiredFiles = {'/Volumes/hd1/Users/cammon/Dropbox/CJA_Msac1.5/iris/IRIS-WS-1.5.1.jar'};
         ...
         if introuble
            if ~isSilent
               ...
               disp('ex.  javaaddpath(''http://www.iris.edu/manuals/javawslibrary/matlab/IRIS-WS-1.5-matlab.jar'');');
            end            
